...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ FIX: adminSignIn now calls POST /api/admin/login on Laravel backend
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden">
      ...
      <Link href="/" className="absolute top-6 left-6 flex items-center gap-2 text-gray-400 hover:text-white">
      ...
      <div className="w-full max-w-md mx-4 relative z-10">
        <div className="bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type="email" placeholder="admin@example.com" value={email}
                  ...
                  className="pl-10 h-12 bg-slate-800 border-white/10 text-white" required />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type={showPassword ? "text" : "password"} placeholder="••••••••"
                  ...
                  className="pl-10 pr-10 h-12 bg-slate-800 border-white/10 text-white" required />
            ...
            <Button type="submit"
              className="w-full h-12 bg-gradient-to-r from-purple-500 to-cyan-500 text-white font-semibold"
              disabled={isLoading}>
